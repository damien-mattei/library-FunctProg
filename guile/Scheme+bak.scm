...
(define-syntax %parse-assignment
  (syntax-rules (<-);)
    ...
    ((_ (clauses ...) (<- name expr) rest ...)
     (begin   (display "%parse-assignment : case 1 : name =") (display (quote name)) (display " expr=") (display (quote expr)) (newline)
       (if (defined-object? name)
	   (letrec* (clauses ...)
		    (display "%parse-assignment : case 1 : defined ")
	  ...
	  (begin (display "%parse-assignment : case 1 : undefined ")  (newline)
